...
ljs_thread.join()
```
In testing, I couldn't go up to the maximal sampling rate from the LabJack U^ [documentation](https://labjack.com/support/datasheets/u6/operation/stream-mode) without dropping samples. But I got almost there e.g. 10 kHz for four analog input channels instead of the advertised 12 kHz.
